const url = "https://db.rotaract3192.org/rest/v1/";
...
async function testFetch() {
  console.log("Testing REST endpoint https://db.rotaract3192.org/rest/v1/ ...");
  try {
    const res = await fetch("https://db.rotaract3192.org/rest/v1/?apikey=" + serviceKey, {
      headers: {
        "apikey": serviceKey,
