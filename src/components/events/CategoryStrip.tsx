            ...
            return (
              <button
                ...
                className={[
                  ...
                  active ? "text-[#1e9df1] font-bold" : "text-gray-500 hover:text-gray-900 font-medium",
                ].join(" ")}
              >
                <Icon size={20} strokeWidth={active ? 2.2 : 1.6} className={active ? "text-[#1e9df1]" : "text-gray-400 group-hover:text-gray-700"} />
                ...
                {active && (
                  <motion.span
                    ...
                    className="absolute -bottom-3.5 left-0 right-0 h-0.5 bg-[#1e9df1] rounded-full"
