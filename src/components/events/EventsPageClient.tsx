      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-gray-200 dark:border-gray-800 pb-4">
        ...
        <div className="bg-gray-100 dark:bg-gray-800 p-1 rounded-2xl flex items-center gap-1 border border-gray-200 dark:border-gray-700 self-start sm:self-auto">
          <button
            ...
            className={`px-3.5 sm:px-4 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer flex items-center gap-1.5 active:scale-95 ${viewMode === "GRID"
          ...
          <button
            ...
            className={`px-3.5 sm:px-4 py-2 rounded-xl text-xs font-extrabold transition-all cursor-pointer flex items-center gap-1.5 active:scale-95 ${viewMode === "MAP"
