      ...
      >
        ...
        <div className="md:hidden px-4 pt-8 pb-32 space-y-6">
            ...
            <Link href="/" className="flex items-center gap-3">
              ...
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5">
                  ...
                  <span className="text-[9px] font-black text-[#1e9df1] bg-blue-50 dark:bg-blue-950/60 border border-blue-200 dark:border-blue-800 px-1.5 py-0.2 rounded-md">
                    3192
                  </span>
                </div>
          ...
          <div className="flex flex-wrap gap-1.5 pt-1">
            ...
            <Link
              href="/privacy-center"
              className="text-xs font-bold bg-blue-50 dark:bg-blue-950/40 text-[#1e9df1] border border-blue-200 dark:border-blue-800 px-3 py-1.5 rounded-xl shadow-2xs active:scale-95 transition-all"
            >
              Privacy Center
            </Link>
          </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    ...
                    {isOpen ? (
                      <ChevronUp size={16} className="text-[#1e9df1]" />
                    ) : (
                      ...
                      >
                        {col.links.map((link) => (
                          <Link
                            key={link.href}
                            href={link.href}
                            className="block text-xs font-medium text-gray-600 dark:text-gray-400 hover:text-[#1e9df1] py-1 active:text-[#1e9df1]"
                          >
                            {link.label}
                          </Link>
                        ))}
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3 text-gray-500 dark:text-gray-400">
                <a
                  ...
                  className="p-2 rounded-xl bg-gray-100 dark:bg-gray-800 hover:text-[#1e9df1] transition-colors"
                >
